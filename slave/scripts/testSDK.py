...
code = Ailezan("api-4tuoz9od", "meiriq2014", 34379)
# code = Jima("xiaoxiaozhuan", "meiriq2014", 170)
# code = Shenhua("xiaoxiaozhuan", "meiriq2014", 37062)
# code = Yima("xiaoxiaozhuan", "meiriq2014", 26)

code.login()
time.sleep(1)
phone_num = code.getPhone(locationMatching="include", locationLevel="p", location="江苏")
