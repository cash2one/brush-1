...
from machines.machinenewPinganpuhui import Machinex, Machinex2
...
class TotalMachine(WorkMachine):
    ...
    def setup_machine(self):
        ...
        self.machine008.task_schedule = ["record_file", "clear_data", "uninstall_apk", "find_apk", "modify_data_suiji"]    # 007 task list
