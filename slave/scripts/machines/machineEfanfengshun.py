...
class Machinex(Machine):
    ...
    def begin(self):
        ...
        time.sleep(10)
        #检测已进入app
        WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/headImg"))
        ...
        if sign_rate <= 10000:
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/headImg")).click()
            time.sleep(1)
    ...
    def signup(self):
        ...
        try:
            #进入注册页面
            WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/login_btn_register_account")).click()
            time.sleep(1)
            #选择接码平台获取手机号码
            ...
            time.sleep(1)
            #点击获取验证码按钮
            WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/register_btn_register")).click()
            time.sleep(5)
            try:
                WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/login_dialog_right")).click()
                time.sleep(5)
            ...
            time.sleep(1)
            #点击完成按钮按钮
            WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/verify_btn_commit")).click()
            time.sleep(1)
            #检测注册成功进入下一步
            WebDriverWait(dr, 60).until(lambda d: d.find_element_by_name("回到首页")).click()
            time.sleep(1)
    ...
    def after_signup(self):
        dr = self.driver
        WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/settingImg")).click()
        time.sleep(1)
        WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/userBasicInfoLinearLayout")).click()
        time.sleep(1)
        WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/rl_user_nick_layout")).click()
        time.sleep(1)
        #输入昵称
        edts = WebDriverWait(dr, 15).until(lambda d: d.find_element_by_class_name("android.widget.EditText"))
        edts.send_keys(self.get_filemessage("name.txt"))
        time.sleep(1)
        WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/btn_title_right_button")).click()
        time.sleep(1)
        #选择头像
        if not random.randint(0, 9):
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/userThumbnail")).click()
            time.sleep(1)
            WebDriverWait(dr, 5).until(lambda d: d.find_element_by_name("从相册中选取")).click()
            time.sleep(1)
            ...
            time.sleep(1)
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/ok")).click()
            time.sleep(5)
        #保存信息按钮
        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/editInfoConfrimBtn")).click()
        time.sleep(10)
        #检测信息保存完毕跳转页面
        WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/tv_title_back_text")).click()
        time.sleep(1)
        #记录帐号密码
        try:
            ...
            while self.readnum:
                ...
                if random_read == 0:
                    if self.ismenu1:
                        print("goto menu1")
                        try:
                            WebDriverWait(dr, 15).until(lambda d: d.find_elements_by_id("android.widget.ImageButton"))[0].click()
                            time.sleep(5)
                    ...
                    if self.ismenu2:
                        print("goto menu2")
                        try:
                            WebDriverWait(dr, 15).until(lambda d: d.find_elements_by_id("android.widget.ImageButton"))[1].click()
                            time.sleep(5)
                            time.sleep(random.randint(15, 30))
                        except TimeoutException:
                            pass
                    ...
                    if self.ismenu3:
                        print("goto menu3")
                        try:
                            WebDriverWait(dr, 15).until(lambda d: d.find_elements_by_id("android.widget.ImageButton"))[2].click()
                            time.sleep(5)
                            time.sleep(random.randint(15, 30))
                        except TimeoutException:
                            pass
...
class Machinex2(Machine):
    ...
    def login(self):
        ...
        if user and pwd:
            ...
            time.sleep(1)
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/login_btn_login")).click()
            time.sleep(5)
            WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.pafinancialtech.shundebank:id/headImg"))
        time.sleep(5)
        return self.do
