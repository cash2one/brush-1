...
class Machinex(Machine):
    def __init__(self, driver, code_platform, fm_uname, fm_pwd):
        ...
        self.appname = "山东24小时"       #app名字
        self.appname_en = "shandong"     #记录文件用缩写英文名
        self.imei = None
    ...
    def initdata(self):
        ...
        if self.code_platform == "feima":
            ...
            self.code = Ailezan(self.code_user, self.code_pwd, 8048)
    ...
    def begin(self):
        ...
        time.sleep(10)
        #检测已进入app
        WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/guide_item_img"))
        ...
        WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/guide_btn")).click()
        #注册率
        sign_rate = random.randint(1, 10000)
        if sign_rate <= 5000:
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/fragment_service_image")).click()
            time.sleep(1)
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_header_login_layout")).click()
            time.sleep(1)
    ...
    def signup(self):
        ...
        try:
            #进入注册页面
            WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/login_register")).click()
            time.sleep(1)
            #选择接码平台获取手机号码
            self.phone = self.code.getPhone(locationMatching='include', locationLevel='p', location="山东")
            edts = WebDriverWait(dr, 15).until(lambda d: d.find_elements_by_class_name("android.widget.EditText"))
            #输入手机号码
            edts[0].send_keys(self.phone)
            time.sleep(1)
            #点击获取验证码按钮
            WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/register_retry")).click()
            time.sleep(5)
            #输入密码
            edts[2].send_keys(self.pwd)
            time.sleep(1)
            #选择接码平台获取验证码
            #验证码：188608，用于注册山东24小时账号，请妥善保管（30分钟内有效）【大众网】(来自1069022150068)
            regrex = r'验证码：(\d+)'
            ...
            time.sleep(1)
            #点击完成按钮按钮
            WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/register_next")).click()
            time.sleep(1)
            #检测注册成功进入下一步
            WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_header_login_layout")).click()
            time.sleep(1)
    ...
    def after_signup(self):
        dr = self.driver
        #输入昵称
        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_info_nick_layout")).click()
        time.sleep(1)
        ...
        time.sleep(1)
        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/modify_save")).click()
        time.sleep(1)
        #输入登录名
        # if random.randint(1, 1):
        #     WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_info_name_layout")).click()
        #     time.sleep(1)
        #     edts = WebDriverWait(dr, 15).until(lambda d: d.find_element_by_class_name("android.widget.EditText"))
        #     edts.send_keys(self.get_filemessage("name.txt"))
        #     time.sleep(1)
        ...
        if random.randint(0, 1):
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_info_gender_layout")).click()
            time.sleep(1)
            WebDriverWait(dr, 20).until(lambda d: d.find_element_by_name(choice(["男", "女", "保密"]))).click()
            time.sleep(1)
        #输入地区
        if random.randint(0, 1):
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_info_city_layout")).click()
            time.sleep(1)
            self.swipes(300, random.randint(800, 1000), 300, random.randint(300, 600), random.randint(0, 1), 2, 2)
            self.select_one_by_id("com.dzwww.sd.android:id/add_service_left_text")
            time.sleep(1)
            self.select_one_by_id("com.dzwww.sd.android:id/add_service_right_text")
            time.sleep(5)
        #选择头像
        if not random.randint(0, 9):
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_header_layout")).click()
            time.sleep(1)
            ...
            time.sleep(10)
        #保存信息按钮
        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/activity_back")).click()
        time.sleep(5)
        #检测信息保存完毕跳转页面
        WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/fragment_service_image"))
        #记录帐号密码
        try:
        ...
        try:
            while self.readnum:
                ...
                if random_read == 0:
                    if self.ismenu1:
                        print("goto menu1")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/fragment_main_image")).click()
                        time.sleep(5)
                        return self.menu1
                    return self.do
                elif random_read == 1:
                    if self.ismenu2:
                        print("goto menu2")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/fragment_activity_image")).click()
                        time.sleep(5)
                        return self.menu2
                    return self.do
                elif random_read == 2:
                    if self.ismenu3:
                        print("goto menu3")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/fragment_scan_image")).click()
                        time.sleep(5)
                        return self.menu3
                    return self.do
                elif random_read == 3:
                    if self.ismenu4:
                        print("goto menu4")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/fragment_deep_image")).click()
                        time.sleep(5)
                        return self.menu4
                    return self.do
                else:
                    if self.ismenu5:
                        print("goto menu5")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/fragment_service_image")).click()
                        time.sleep(5)
                        return self.menu5
                    return self.do
    ...
    def menu1(self):
        ...
        try:
            for _ in range(random.randint(1, 3)):
                ...
                selectone = WebDriverWait(dr, 15).until(lambda d: d.find_elements_by_id(choice(["com.dzwww.sd.android:id/news_item_title", "com.dzwww.sd.android:id/news_type4_item_title"])))
                selectone[random.randint(0, selectone.__len__()-1)].click()
                time.sleep(5)
                try:
                    WebDriverWait(dr, 5).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/news_content_fav"))
                    time.sleep(1)
                    ...
                    if not random.randint(0, 4):
                        try:
                            WebDriverWait(dr, 5).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/news_content_fav")).click()
                            time.sleep(1)
                        except TimeoutException:
                            pass
                except TimeoutException:
                    for i in range(random.randint(3, 5)):
                        dr.swipe(600, 600, 200, 600)
                        time.sleep(random.randint(2, 5))
                    #收藏
                    if not random.randint(0, 4):
                        try:
                            WebDriverWait(dr, 5).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/imgCollect")).click()
                            time.sleep(1)
                        except TimeoutException:
                            pass
                dr.press_keycode(4)
    ...
    def menu2(self):
        ...
        try:
            try:
                WebDriverWait(dr, 5).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/forum_nav_layout")).click()
                time.sleep(5)
            except TimeoutException:
                pass
            for _ in range(random.randint(1, 3)):
                for i in range(random.randint(1, 3)):
                    dr.swipe(300, random.randint(800, 1000), 300, random.randint(400, 600))
                    time.sleep(random.randint(2, 5))
                self.select_one_by_id("com.dzwww.sd.android:id/forum_listview_item_title")
                time.sleep(5)
                for i in range(random.randint(3, 5)):
                    dr.swipe(300, random.randint(800, 1000), 300, random.randint(400, 600))
                    time.sleep(random.randint(2, 5))
                ...
                if not random.randint(0, 4):
                    try:
                        WebDriverWait(dr, 5).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/forum_content_fav")).click()
                        time.sleep(1)
                    except TimeoutException:
                        pass
                dr.press_keycode(4)
    ...
    def menu4(self):
        dr = self.driver
        try:
            self.select_one_by_id("com.dzwww.sd.android:id/main_service_parent_layout")
...
class Machinex2(Machine):
    ...
    def login(self):
        ...
        if user and pwd:
            ...
            time.sleep(1)
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/login_login_btn")).click()
            time.sleep(5)
            WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.dzwww.sd.android:id/personal_header_login_layout"))
        time.sleep(5)
        return self.do
