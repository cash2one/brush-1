...
class Machinex(Machine):
    ...
    def begin(self):
        ...
        time.sleep(10)
        try:
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.shwatch.news:id/sdl__content"))
            time.sleep(1)
            dr.press_keycode(4)
            time.sleep(1)
        ...
        if sign_rate <= 1000:
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.shwatch.news:id/user_btn")).click()
            time.sleep(1)
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.shwatch.news:id/login_btn")).click()
            time.sleep(1)
    ...
    def signup(self):
        ...
        try:
            ...
            for x in range(5):
                try:
                    WebDriverWait(dr, 10).until(lambda d: d.find_element_by_id("com.shwatch.news:id/login_btn")).click()
                    time.sleep(1)
                except TimeoutException:
                    break
            #登录完成
            WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.shwatch.news:id/user_info"))
            self.issign = True
    ...
    def after_signup(self):
        dr = self.driver
        try:
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.shwatch.news:id/user_info")).click()
            time.sleep(1)
            #修改名字
            if random.randint(0, 1):
                WebDriverWait(dr, 60).until(lambda d: d.find_element_by_id("com.shwatch.news:id/nickname_layout")).click()
                time.sleep(1)
                #输入昵称
            ...
            if random.randint(0, 9) == 0:
                copyfile("/sdcard/1/1touxiang/PIC\ \(%s\).jpg" % random.randint(1, 1000), "/sdcard/2/")
                time.sleep(1)
                ...
                time.sleep(1)
                WebDriverWait(dr, 15).until(lambda d: d.find_element_by_name("2")).click()
                time.sleep(1)
                ...
                time.sleep(5)
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.shwatch.news:id/btn_callback")).click()
            time.sleep(1)
            for x in range(10):
                dr.press_keycode(4)
                time.sleep(1)
        ...
        try:
            while self.readnum:
                ...
                if random_read == 0:
                    if self.ismenu1:
                        print("goto menu1")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.shwatch.news:id/homepage_btn")).click()
                        time.sleep(5)
                        return self.menu1
                    return self.do
                elif random_read == 1:
                    if self.ismenu2:
                        print("goto menu2")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.shwatch.news:id/activity_btn")).click()
                        time.sleep(5)
                        return self.menu2
                    return self.do
                elif random_read == 2:
                    if self.ismenu3:
                        print("goto menu3")
                        WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.shwatch.news:id/user_btn")).click()
                        time.sleep(5)
                        return self.menu3
                    return self.do
                return self.do
    ...
    def menu1(self):
        ...
        try:
            for _ in range(random.randint(1, 2)):
                ...
                #随机选择新闻查看
                selectone = WebDriverWait(dr, 10).until(lambda d: d.find_elements_by_id(choice(["com.shwatch.news:id/news_1smallitem_layout", "com.shwatch.news:id/section_newsitem"])))
                ...
                if random.randint(0, 9) == 0 and self.issign:
                    try:
                        ...
                        if int(contentnum.text) > 3:
                            ...
                            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.shwatch.news:id/write_comment")).click()
                            time.sleep(1)
                            ...
                            time.sleep(1)
                            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.shwatch.news:id/btn_callback")).click()
                            time.sleep(1)
                    except TimeoutException:
                        pass
                dr.press_keycode(4)
...
class Machinex2(Machine):
    ...
    def login(self):
        ...
        if user and pwd:
            ...
            time.sleep(1)
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.shwatch.news:id/user_info")).click()
            time.sleep(1)
            for x in range(10):
                dr.press_keycode(4)
                time.sleep(1)
