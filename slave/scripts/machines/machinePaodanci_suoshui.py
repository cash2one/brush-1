...
try:
    from util import screenshot, run_qpy2_script, copyfile
except ImportError:
    screenshot = lambda: 1
...
class Machinex(Machine):
    ...
    def begin(self):
        ...
        #检测更新
        try:
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.paoword.www.paoword:id/negative")).click()
            time.sleep(1)
        ...
        try:
            while self.readnum:
                ...
                if random_read == 0:
                    ...
                    if self.ismenu2 and self.issign:
                        print("goto menu2")
                    ...
                    if self.ismenu3 and self.issign:
                        print("goto menu3")
    ...
    def menu1(self):
        ...
        try:
            #添加计划
            try:
                WebDriverWait(dr, 15).until(lambda d: d.find_element_by_name("添加计划")).click()
                time.sleep(1)
                ...
                pass
            #学习
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.paoword.www.paoword:id/begin")).click()
            time.sleep(1)
            ...
            for x in range(random.randint(5, 15)):
                try:
                    ...
                    if not random.randint(0, 4):
                        try:
                            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.paoword.www.paoword:id/actionAddWord")).click()
                            time.sleep(1)
                        except TimeoutException:
                            pass
                    #泡/爆
...
class Machinex2(Machine):
    ...
    def begin(self):
        ...
        #帐号其他地方登录
        try:
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.paoword.www.paoword:id/positive")).click()
            time.sleep(1)
            ...
            pass
        try:
            WebDriverWait(dr, 15).until(lambda d: d.find_element_by_id("com.paoword.www.paoword:id/btn_login_enter")).click()
            time.sleep(1)
            WebDriverWait(dr, 30).until(lambda d: d.find_element_by_id("com.paoword.www.paoword:id/btn_visitor_login")).click()
            time.sleep(1)
        except TimeoutException:
